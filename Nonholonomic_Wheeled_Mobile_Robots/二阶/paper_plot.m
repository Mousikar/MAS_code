...
uijmvz=linspace(0,50,length(erry_actual_history));
...
legend('FontName','Times New Roman','FontSize',12,'Location', 'best','Orientation','horizontal');
...
figure;
set(gcf,'Position',[100,100,800,600]); % 设置图形大小
uijmvz=linspace(0,50,length(x_history));
hold on;
...
plot3([0,0,0,0,0], rxc(hull), ryc(hull), 'r', 'LineWidth', 1, 'DisplayName', 'Convex Hull');
